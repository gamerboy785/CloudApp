	...
	<div id="wrapper" class = "menuDisplayed">
        ...
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                <li ><a href="http://localhost:9090/WebProject/adminHome.jsp" class = "btn" style = "background-color:#006699" role = "button">Home</a></li>
                <li ><a href="http://localhost:9090/WebProject/addRoom.jsp" class = "btn" role = "button">Add Room</a></li>
            	<li><a href="http://localhost:9090/WebProject/viewRooms.jsp" class = "btn" role = "button">View Rooms</a></li>          	
        ...
        <nav class = "navbar navbar-default">
			...
			<div class = "navbar-header">
				...
				<img src = <%=user.getProfileImage() %> alt = "profilePic" width = "100px" height = "100px" />	</div>
				
				<div>    			
					<form action = "UploadProfileImageServlet" method = "post" enctype = "multipart/form-data">
						<label for = "file" >Upload a profile image:</label>
						<input type = "file" name = "file" />
						<input type = "submit" value = "Upload" style = "margin-top:5px; background-color:#a9a9a9" />
					</form>			
				</div>
